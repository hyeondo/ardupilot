...
public:
    ...
    static bool pid_control(uint32_t curTime,float* error_x,float* error_y,int* yaw_val, int* pitch_val);
    static bool read_target_position(float* error_x,float* error_y);
